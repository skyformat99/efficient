# - Find Unwind (libunwind.h, libunwind.a, libunwind.so)
# This module defines
...
#  Unwind_SHARED_LIB_RESOURCES, shared libraries required to use Unwind, i.e. libunwind*.so
...
set(UNWIND_SEARCH_HEADER_PATHS
  ${UNWIND_ROOT}/include
  ${UNWIND_ROOT}/local/include
)

set(UNWIND_SEARCH_LIB_PATH
  ${UNWIND_ROOT}/lib
  ${UNWIND_ROOT}/local/lib
)
