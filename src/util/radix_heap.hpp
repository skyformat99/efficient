/*
 * Radix-Heap priority queue
 *
 * The MIT License (MIT)
 *
 * Copyright (c) 2015 Takuya Akiba
 *
 * Ravindra K. Ahuja, Kurt Mehlhorn, James Orlin, and Robert E. Tarjan. 
 * Faster algorithms for the shortest path problem. J. ACM 37, 2 (April 1990), 213-223.
 *
 */
